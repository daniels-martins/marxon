    ...
    $(document).ready(function () {
        ...
        if ($(".main-header .navigation li.dropdown ul").length) {
            $(".main-header .navigation li.dropdown").append(
                '<div class="dropdown-btn"><span class="fas fa-plus"></span></div>'
            );
        ...
        // {udo js code} 07b. Product Slider
        ...
        if ($(".blog-slider").length) {
            $(".blog-slider").slick({
                ...
                slidesToShow: 1,
                prevArrow:
                    '<button class="blog-slider-prev"><i class="fas fa-angle-left"></i></button>',
                nextArrow:
                    '<button class="blog-slider-next"><i class="fas fa-angle-right"></i></button>',
            });
        }
