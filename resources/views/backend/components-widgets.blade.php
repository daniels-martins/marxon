            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="components-widgets.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="components-widgets.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="font-16 m-0">
                                    <span class="float-right">
                                        <a href="components-widgets.html" class="text-dark">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="components-widgets.html#" role="button" aria-haspopup="false" aria-expanded="false">
...
<div class="left-side-menu">
                ...
                <div class="user-box">
                        ...
                        <div class="user-info">
                            <a href="components-widgets.html#">Stanley Jones</a>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="card-box">
                                    <a href="components-widgets.html#" class="btn btn-sm btn-primary float-right">View</a>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card-box">
                                    ...
                                    <p class="text-muted">In nec rhoncus eros Vestibulum an mattis viverra sometimes magna nec pulvinar. Maecenas pellentesque porta auguesa consectetur facilisis diam poritor purus... <a href="components-widgets.html" class="text-primary"><b>Read More</b></a> </p>
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="components-widgets.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
