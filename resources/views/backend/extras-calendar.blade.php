            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="extras-calendar.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="extras-calendar.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="font-16 m-0">
                                    <span class="float-right">
                                        <a href="extras-calendar.html" class="text-dark">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="extras-calendar.html#" role="button" aria-haspopup="false" aria-expanded="false">
...
<div class="left-side-menu">
                ...
                <div class="user-box">
                        ...
                        <div class="user-info">
                            <a href="extras-calendar.html#">Stanley Jones</a>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <div>
                                    <a href="extras-calendar.html#" data-toggle="modal" data-target="#add-category" class="btn btn-lg btn-danger btn-block waves-effect waves-light">
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="extras-calendar.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
