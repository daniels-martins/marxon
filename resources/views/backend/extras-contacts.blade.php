            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="extras-contacts.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="extras-contacts.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="font-16 m-0">
                                    <span class="float-right">
                                        <a href="extras-contacts.html" class="text-dark">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="extras-contacts.html#" role="button" aria-haspopup="false" aria-expanded="false">
...
<div class="left-side-menu">
                ...
                <div class="user-box">
                        ...
                        <div class="user-info">
                            <a href="extras-contacts.html#">Stanley Jones</a>
                ...
                <div class="content">
                                ...
                                <div class="text-center card-box ribbon-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@CEO <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                                        ...
                                        <ul class="social-links list-inline mt-4 pt-2 mb-0">
                                            <li class="list-inline-item">
                                                <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="extras-contacts.html" data-original-title="Facebook"><i class="fab fa-facebook-f"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="extras-contacts.html" data-original-title="Twitter"><i class="fab fa-twitter"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a title="" data-placement="top" data-toggle="tooltip" class="tooltips" href="extras-contacts.html" data-original-title="Skype"><i class="fab fa-skype"></i></a>
                                            </li>
                                        </ul>
                                ...
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@Founder <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                                ...
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@Webdesigner <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                                ...
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@Manager <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                                ...
                                <div class="text-center card-box ribbon-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@Webdeveloper <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                                ...
                                <div class="text-center card-box">
                                    <div class="member-card">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-muted">@Product Manager <span> | </span> <span> <a href="extras-contacts.html#" class="text-pink">websitename.com</a> </span></p>
                                        </div>
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="extras-contacts.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
