            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="forms-advanced.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="forms-advanced.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="font-16 m-0">
                                    <span class="float-right">
                                        <a href="forms-advanced.html" class="text-dark">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="forms-advanced.html#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mt-5">
                                    ...
                                    <div class="">
                                        <form action="forms-advanced.html#" class="form-validation">
                                            <div class="form-group">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6">
                                <div class="mt-5">
                                    ...
                                    <div class="">
                                        <form action="forms-advanced.html#">
                                            <div class="form-group">
                                                <label>Default</label>
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="forms-advanced.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
