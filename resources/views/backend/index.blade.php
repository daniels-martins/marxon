            ...
            <div class="content">
                                    ...
                                    <table class="table table-hover mails m-0 table table-actions-bar table-centered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.html#" class="text-muted">tomaslau@dummy.com</a>
                                                </td>

                                                <td>
                                                    <b><a href="index.html" class="text-dark"><b>356</b></a>
                                                    </b>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <img src="assets/backend/images/users/avatar-1.jpg"
                                                        alt="contact-img" title="contact-img"
                                                        class="rounded-circle avatar-sm" />
                                                </td>
                                                ...
                                                <td>
                                                    <a href="index.html#" class="text-muted">chadengle@dummy.com</a>
                                                </td>

                                                <td>
                                                    <b><a href="index.html" class="text-dark"><b>568</b></a>
                                                    </b>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.html#"
                                                        class="text-muted">stillnotdavid@dummy.com</a>
                                                </td>
                                                <td>
                                                    <b><a href="index.html" class="text-dark"><b>201</b></a>
                                                    </b>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.html#" class="text-muted">kurafire@dummy.com</a>
                                                </td>

                                                <td>
                                                    <b><a href="index.html" class="text-dark"><b>56</b></a>
                                                    </b>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.html#" class="text-muted">shahedk@dummy.com</a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.html#"
                                                        class="text-muted">adhamdannaway@dummy.com</a>
                                                </td>

                                                <td>
                                                    <b><a href="index.html" class="text-dark"><b>956</b></a>
                                                    </b>
                                                </td>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                2017 - 2020 &copy; Simple theme by <a href="index.html">Coderthemes</a>
                            </div>
                        </div>
                    </div>
                </footer>
