                    ...
                    <div class="container-fluid">
                        <ul class="list-unstyled topnav-menu float-right mb-0">
                            ...
                            <li class="dropdown d-none d-lg-block">
                                <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="layouts-horizontal.html#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="assets/images/flags/us.jpg" alt="user-image" height="12"> <span class="align-middle d-none d-xl-inline-block ml-2">English <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="layouts-horizontal.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="layouts-horizontal.html#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <div id="navigation">
                            ...
                            <ul class="navigation-menu">
                                ...
                                <li class="has-submenu">
                                    <a href="layouts-horizontal.html#"> <i class="ti-files"></i>Pages</a>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu">
                                    <a href="layouts-horizontal.html#"> <i class="ti-spray"></i>Other </a>
                                    <ul class="submenu">
                                        <li><a href="ui-elements.html">UI Elements</a></li>
                                        <li class="has-submenu">
                                            <a href="layouts-horizontal.html#">Components <div class="arrow-down"></div></a>
                                            <ul class="submenu">
                                        ...
                                        <li class="has-submenu">
                                            <a href="layouts-horizontal.html#">Forms <div class="arrow-down"></div></a>
                                            <ul class="submenu">
                                        ...
                                        <li class="has-submenu">
                                            <a href="layouts-horizontal.html#">Tables <div class="arrow-down"></div></a>
                                            <ul class="submenu">
                                ...
                                <li class="has-submenu">
                                    <a href="layouts-horizontal.html#"> <i class="ti-widget"></i>Extra Pages </a>
                                    <ul class="submenu">
                                ...
                                <li class="has-submenu">
                                    <a href="layouts-horizontal.html#"> <i class="mdi mdi-flip-horizontal"></i>Layouts</a>
                                    <ul class="submenu">
                ...
                <div class="content">
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar table-centered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">tomaslau@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-horizontal.html" class="text-dark"><b>356</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">chadengle@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-horizontal.html" class="text-dark"><b>568</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">stillnotdavid@dummy.com</a>
                                                    </td>
                                                    <td>
                                                        <b><a href="layouts-horizontal.html" class="text-dark"><b>201</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">kurafire@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-horizontal.html" class="text-dark"><b>56</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">shahedk@dummy.com</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-horizontal.html#" class="text-muted">adhamdannaway@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-horizontal.html" class="text-dark"><b>956</b></a>
                                                        </b>
                                                    </td>
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="layouts-horizontal.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
