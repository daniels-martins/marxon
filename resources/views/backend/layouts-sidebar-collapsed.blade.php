            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown d-none d-lg-block">
                        <a class="nav-link dropdown-toggle mr-0" data-toggle="dropdown" href="layouts-sidebar-collapsed.html#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="layouts-sidebar-collapsed.html#" role="button" aria-haspopup="false" aria-expanded="false">
                            ...
                            <div class="dropdown-item noti-title">
                                <h5 class="font-16 m-0">
                                    <span class="float-right">
                                        <a href="layouts-sidebar-collapsed.html" class="text-dark">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="layouts-sidebar-collapsed.html#" role="button" aria-haspopup="false" aria-expanded="false">
...
<div class="left-side-menu">
                ...
                <div class="user-box">
                        ...
                        <div class="user-info">
                            <a href="layouts-sidebar-collapsed.html#">Stanley Jones</a>
                ...
                <div class="content">
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar table-centered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">tomaslau@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-sidebar-collapsed.html" class="text-dark"><b>356</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">chadengle@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-sidebar-collapsed.html" class="text-dark"><b>568</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">stillnotdavid@dummy.com</a>
                                                    </td>
                                                    <td>
                                                        <b><a href="layouts-sidebar-collapsed.html" class="text-dark"><b>201</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">kurafire@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-sidebar-collapsed.html" class="text-dark"><b>56</b></a>
                                                        </b>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">shahedk@dummy.com</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="layouts-sidebar-collapsed.html#" class="text-muted">adhamdannaway@dummy.com</a>
                                                    </td>

                                                    <td>
                                                        <b><a href="layouts-sidebar-collapsed.html" class="text-dark"><b>956</b></a>
                                                        </b>
                                                    </td>
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    2017 - 2020 &copy; Simple theme by <a href="layouts-sidebar-collapsed.html">Coderthemes</a>
                                </div>
                            </div>
                        </div>
                    </footer>
