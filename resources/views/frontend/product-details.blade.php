...
@section('content')
    ...
    <section class="product-details rel z-1 py-140 rpy-100">
        <div class="container">
            <div class="row no-gap align-items-center">
                <div class="col-lg-10">
                    <div class="product-details-image wow fadeInLeft delay-0-2s">
                        <img src="/assets/images/portfolios/portfolio-details.jpg" alt="Portfolio">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="product-description bg-dark-blue br-10 wow fadeInRight delay-0-2s">
                        <table>
                            <tr>
                                <td><b>Date</b></td>
                                <td><b>:</b></td>
            ...
            <div class="product-details-content pb-35 wow fadeInUp delay-0-2s">
            ...
            <hr>
            <div class="product-footer-nav pt-25">
