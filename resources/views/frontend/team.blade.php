...
<body>
    <div class="page-wrapper">
                    ...
                    <div class="header-inner d-flex align-items-center">
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="team.html#">portfolio</a>
                                            <ul>
                        ...
                        <div class="menu-icons">
                            ...
                            <div class="nav-search py-15">
                                ...
                                <form action="team.html#" class="hide">
        ...
        <section class="page-banner rel z-1 bg-lighter text-center py-110 rpy-90"
            ...
            <div class="container">
                <div class="banner-inner rel">
                    <h2 class="page-title wow fadeInUp delay-0-2s">Team Member</h2>
        ...
        <!-- Team Section Start -->
        <section class="team-section-one pt-135 rpt-95 rel z-1">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-2s">
                            <img src="assets/images/team/team-member5.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-4s">
                            <img src="assets/images/team/team-member6.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-6s">
                            <img src="assets/images/team/team-member7.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member wow fadeInUp delay-0-8s">
                            <img src="assets/images/team/team-member8.jpg" alt="Team Member">
                            <div class="member-description">
                                <div class="social-area">
                                    <div class="social-icons">
                                        <a href="contact.html"><i class="fab fa-twitter"></i></a>
        ...
        <!-- Team Section Start -->
        <section class="team-section-two pt-105 rpt-65 pb-110 rpb-70 rel z-0">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title text-center mb-60">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="footer-widget about-widget">
                            ...
                            <div class="footer-contact mt-30">
                                ...
                                <a
                                    href="https://demo.webtend.net/cdn-cgi/l/email-protection#365f5850597642535a55591855595b"><span
                                        class="__cf_email__"
                                        data-cfemail="b8d1d6ded7f8ccddd4dbd796dbd7d5">[email&#160;protected]</span></a>
                            </div>
                        </div>
                    </div>
